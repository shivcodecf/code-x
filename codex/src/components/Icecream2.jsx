...
import icecream2 from "../assets/icecream 2.png";
        ...
        <div className=" flex-1 mt-[-40px] flex flex-col justify-center space-y-4 text-center md:text-left px-2 md:mt-[-100px]">
          ...
          <div className="grid grid-cols-2 md:flex md:flex-nowrap gap-6 pt-10 h-auto md:h-[100px] mt-[-40px] md:mt-[-80px] justify-center md:justify-start">
            {images.map((ice, index) => (
              ...
              >
                {/* White border box with animation */}
                <motion.div
                  initial={{ opacity: 1 }}
                ...
                <div className="relative w-full md:w-[204px] ml-0 md:ml-[-21px] h-[100px] md:h-[120px] overflow-hidden flex justify-center">
                  ...
                  >
                    <img
                      src={ice}
                      alt={`ice-${index}`}
                      className="w-[150px] md:w-[240px] mt-[10px] h-[90px] md:h-[110px] object-contain transition-transform duration-500 ease-in-out origin-bottom hover:rotate-[13deg] hover:scale-110"
                    />
                  </button>
                </div>
              </div>
